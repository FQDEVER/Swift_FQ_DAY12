...
//            let leftViewX = FQ_SlideConfiguration.shared.transitionDirection == .Left ? 0 : ScreenW * 0.25
            ...
            toVc.view.frame = CGRect(x: -CGFloat(num) * ScreenW * 0.75 * 0.5, y: 0, width: ScreenW * 0.75, height: ScreenH)
//            toVc.leftView.frame = CGRect(x: leftViewX, y: 100, width: ScreenW * 0.75, height: ScreenH - 200)
...
//            let leftViewX = FQ_SlideConfiguration.shared.transitionDirection == .Left ? 0 : ScreenW * 0.25
            toVc.view.frame = CGRect(x: num > 0 ? -ScreenW * 0.75 * 0.5 : (1 - 0.75 * 0.5) * ScreenW , y: 0, width: ScreenW * 0.75, height: ScreenH)
...
//        toVc.leftView.frame = toVc.view.bounds
